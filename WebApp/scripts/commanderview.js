...
var CommanderView = (function () {
    function CommanderView(id) {
        ...
        this.tableView.setOnToggleSelection(function (i) { return _this.itemsSorter.toggleSelection(i); });
        ...
        commanderTable.onkeydown = function (e) {
            switch (e.which) {
                ...
                case 45:
                    ...
                    break;
                case 46:
                    _this.processOperation(null, function (n) { return _this.getDeleteOperationData(n); }, function (r) { return _this.operateDelete(r); });
                    break;
                case 69:
                    if (e.ctrlKey) {
                        e.preventDefault();
                ...
                case 113:
                    ...
                    break;
                case 116:
                    _this.processOperation(null, function (n) { return _this.getCopyOperationData(n); }, function (result) {
                        _this.operateFile(result, "Möchtest Du die ausgewählten Dateien kopieren?", false);
                    });
                    break;
                case 117:
                    _this.processOperation(null, function (n) { return _this.getMoveOperationData(n); }, function (result) {
    ...
    CommanderView.prototype.drop = function (dragDropKind, directory, items) {
        var _this = this;
        ...
        var u = directory;
        this.processOperation(items, function (n) { return dragDropKind == DragDropKind.Copy ? _this.getDropCopyOperationData(directory, n) : _this.getDropMoveOperationData(directory, n); }, function (result) {
            _this.operateFile(result, "M\u00F6chtest Du die ausgew\u00E4hlten Dateien " + (dragDropKind == DragDropKind.Copy ? 'kopieren' : 'verschieben') + "?", false);
        });
    };
    ...
    CommanderView.prototype.processOperation = function (dropSelection, getOperationData, operate) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        selection = dropSelection ? dropSelection : this.getSelectedItems();
                        if (!selection.length)
                            return [2 /*return*/];
    ...
    CommanderView.prototype.getDropCopyOperationData = function (sourceDir, selection) {
        return {
            operation: "copy",
            sourceDir: sourceDir,
            targetDir: this.otherView.currentDirectory,
    ...
    CommanderView.prototype.getDropMoveOperationData = function (sourceDir, selection) {
        return {
            operation: "move",
            sourceDir: sourceDir,
            targetDir: this.otherView.currentDirectory,
